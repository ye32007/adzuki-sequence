...
@Service(interfaceClass = SequenceGeneratorDayRepeat.class)
@Component("sequenceGeneratorDayRepeatImpl")
public class SequenceGeneratorDayRepeatImpl extends SequenceGeneratorAble implements SequenceGeneratorDayRepeat {

	private final static Logger logger = LoggerFactory.getLogger(SequenceGeneratorDayRepeatImpl.class.getName());
	final static String baseDir = InitSystemEvnAndProp.systemEvnAndProp.get("catalina.base")+ "/cluster/day/";
	...
	public String getNextUUID(String seqName) {
		return DateTimeUtil.getCurrentDate()+ clusterName + handler(seqName);
	}
	...
	public static void main(String[] args) {
		final SequenceGeneratorDayRepeat gen = new SequenceGeneratorDayRepeatImpl();
